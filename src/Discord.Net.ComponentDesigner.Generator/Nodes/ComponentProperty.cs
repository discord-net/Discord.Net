...
{
    public ComponentNodeContext Context => Node.Context;
    ...
    public override string ToString()
    {
        ...
        {
            ComponentPropertyValue<T>.Serializable(_, var value) => Serialize(value),
            ComponentPropertyValue<T>.Interpolated(_, var index) => $"designer.GetValue<{typeof(T)}>({index})",
            ComponentPropertyValue<T>.MultiPartInterpolation(_, var multipart) => BuildMultipart(multipart),
            ComponentPropertyValue<T>.InlineCode(_, var code) => code,
    ...
    public ComponentPropertyValue<T> DangerousCreateCode(
        string code
    ) => new ComponentPropertyValue<T>.InlineCode(this, code);
