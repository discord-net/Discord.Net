...
namespace Discord
{
    public class EmbedBuilder
    {
            ...
            set
            {
                if (value?.Length > MaxDescriptionLength)
                    throw new ArgumentException(
                        $"Description length must be less than or equal to {MaxDescriptionLength}.",
                        nameof(Description));
                _description = value;
            }
        }
        ...
        public string ThumbnailUrl
        {
            ...
            set
            {
                if (!value.IsNullOrUri())
                    throw new ArgumentException("Url must be a well-formed URI", nameof(ThumbnailUrl));
        ...
        public string ImageUrl
        {
            ...
            {
                if (!value.IsNullOrUri())
                    throw new ArgumentException("Url must be a well-formed URI", nameof(ImageUrl));
        ...
        public List<EmbedFieldBuilder> Fields
        {
            ...
            {
                if (value == null)
                    throw new ArgumentNullException("Cannot set an embed builder's fields collection to null",
                        nameof(Fields));
        ...
        public Embed Build()
        {
            if (Length > MaxEmbedLength)
                throw new InvalidOperationException(
                    $"Total embed length must be less than or equal to {MaxEmbedLength}");
        ...
        public string Name
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                    throw new ArgumentException("Field name must not be null, empty or entirely whitespace.",
                        nameof(Name));
                if (value.Length > MaxFieldNameLength)
                    throw new ArgumentException(
                        $"Field name length must be less than or equal to {MaxFieldNameLength}.", nameof(Name));
                _name = value;
            }
        }
        ...
        public object Value
        {
            ...
            set
            {
                ...
                if (stringValue.Length > MaxFieldValueLength)
                    throw new ArgumentException(
                        $"Field value length must be less than or equal to {MaxFieldValueLength}.", nameof(Value));
                _value = stringValue;
            }
        }
        ...
        public string Name
        {
            ...
            set
            {
                if (value?.Length > MaxAuthorNameLength)
                    throw new ArgumentException(
                        $"Author name length must be less than or equal to {MaxAuthorNameLength}.", nameof(Name));
                _name = value;
            }
        }
        ...
        public string Text
        {
            ...
            set
            {
                if (value?.Length > MaxFooterTextLength)
                    throw new ArgumentException(
                        $"Footer text length must be less than or equal to {MaxFooterTextLength}.", nameof(Text));
                _text = value;
            }
        }
