...
namespace Discord
{
    public interface IGuild : IDeletable, ISnowflakeEntity
    {
        ...
        /// <summary>
        ///     Gets the level of mfa requirements a user must fulfill before being allowed to perform administrative actions
        ///     in this guild.
        /// </summary>
        ...
        Task<IReadOnlyCollection<ITextChannel>> GetTextChannelsAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);

        Task<ITextChannel> GetTextChannelAsync(ulong id, CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);

        Task<IReadOnlyCollection<IVoiceChannel>> GetVoiceChannelsAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);

        Task<IReadOnlyCollection<ICategoryChannel>> GetCategoriesAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);
        ...
        Task<ITextChannel> GetSystemChannelAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);

        Task<ITextChannel> GetDefaultChannelAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);

        Task<IGuildChannel> GetEmbedChannelAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null);

        /// <summary> Creates a new text channel. </summary>
        Task<ITextChannel> CreateTextChannelAsync(string name, Action<TextChannelProperties> func = null,
            RequestOptions options = null);

        /// <summary> Creates a new voice channel. </summary>
        Task<IVoiceChannel> CreateVoiceChannelAsync(string name, Action<VoiceChannelProperties> func = null,
            RequestOptions options = null);
        ...
        Task<IRole> CreateRoleAsync(string name, GuildPermissions? permissions = null, Color? color = null,
            bool isHoisted = false, RequestOptions options = null);

        /// <summary> Gets a collection of all users in this guild. </summary>
        Task<IReadOnlyCollection<IGuildUser>> GetUsersAsync(CacheMode mode = CacheMode.AllowDownload,
            RequestOptions options = null); //TODO: shouldnt this be paged?
        ...
        /// <summary>
        ///     Removes all users from this guild if they have not logged on in a provided number of days or, if simulate is
        ///     true, returns the number of users that would be removed.
        /// </summary>
        Task<int> PruneUsersAsync(int days = 30, bool simulate = false, RequestOptions options = null);

        /// <summary> Gets the specified number of audit log entries for this guild. </summary>
        Task<IReadOnlyCollection<IAuditLogEntry>> GetAuditLogsAsync(
            int limit = DiscordConfig.MaxAuditLogEntriesPerBatch,
        ...
        Task<GuildEmote> CreateEmoteAsync(string name, Image image,
        ...
        Task<GuildEmote> ModifyEmoteAsync(GuildEmote emote, Action<EmoteProperties> func,
            RequestOptions options = null);
