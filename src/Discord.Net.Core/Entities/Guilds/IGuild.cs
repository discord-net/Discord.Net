...
namespace Discord
{
    ...
    public interface IGuild : IDeletable, ISnowflakeEntity
    {
        ...
        /// <param name="options">The options to be used when sending the request.</param>
        /// <remarks>
        ///     When using <paramref name="guildMemberCacheMode"/> set to <see cref="CacheMode.CacheOnly"/>, the author of retrieved messages will be a cached <see cref="IGuildUser"/>
