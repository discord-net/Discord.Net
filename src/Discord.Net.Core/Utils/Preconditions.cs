...
namespace Discord
{
    internal static class Preconditions
    {
        ...
        {
            if (obj.IsSpecified && obj.Value.Length == 0) throw CreateNotEmptyException(name, msg);
        }
        ...
        {
            if (obj.IsSpecified && obj.Value == value) throw CreateNotEqualException(name, msg, value);
        }
        ...
        {
            if (obj.IsSpecified && obj.Value < value) throw CreateAtLeastException(name, msg, value);
        }
        ...
        {
            if (obj.IsSpecified && obj.Value <= value) throw CreateGreaterThanException(name, msg, value);
        }
        ...
        {
            if (obj.IsSpecified && obj.Value > value) throw CreateAtMostException(name, msg, value);
        }
        ...
        {
            if (obj.IsSpecified && obj.Value >= value) throw CreateLessThanException(name, msg, value);
        }
