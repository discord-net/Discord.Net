...
namespace Discord
{
    internal static class CollectionExtensions
    {
        ...
        public static IReadOnlyCollection<TValue> ToReadOnlyCollection<TKey, TValue>(
        ...
        public static IReadOnlyCollection<TValue> ToReadOnlyCollection<TValue>(this IEnumerable<TValue> query,
            Func<int> countFunc)
