...
namespace Discord.API
{
    ...
    {
        private static readonly ConcurrentDictionary<string, Func<BucketIds, string>> _bucketIdGenerators =
            new ConcurrentDictionary<string, Func<BucketIds, string>>();
        ...
        public DiscordRestApiClient(RestClientProvider restClientProvider, string userAgent,
        ...
        internal Task SendAsync(string method, Expression<Func<string>> endpointExpr, BucketIds ids,
            ...
            => SendAsync(method, GetEndpoint(endpointExpr), GetBucketId(ids, endpointExpr, AuthTokenType, funcName),
                clientBucket, options);

        public async Task SendAsync(string method, string endpoint,
            string bucketId = null, ClientBucketType clientBucket = ClientBucketType.Unbucketed,
        ...
        internal Task SendJsonAsync(string method, Expression<Func<string>> endpointExpr, object payload, BucketIds ids,
            ...
            => SendJsonAsync(method, GetEndpoint(endpointExpr), payload,
                GetBucketId(ids, endpointExpr, AuthTokenType, funcName), clientBucket, options);
        ...
        internal Task SendMultipartAsync(string method, Expression<Func<string>> endpointExpr,
        ...
        public async Task SendMultipartAsync(string method, string endpoint,
            IReadOnlyDictionary<string, object> multipartArgs,
            string bucketId = null, ClientBucketType clientBucket = ClientBucketType.Unbucketed,
            RequestOptions options = null)
        {
            options = options ?? new RequestOptions();
        ...
        internal Task<TResponse> SendAsync<TResponse>(string method, Expression<Func<string>> endpointExpr,
            BucketIds ids,
            ClientBucketType clientBucket = ClientBucketType.Unbucketed, RequestOptions options = null,
            [CallerMemberName] string funcName = null) where TResponse : class
            => SendAsync<TResponse>(method, GetEndpoint(endpointExpr),
                GetBucketId(ids, endpointExpr, AuthTokenType, funcName), clientBucket, options);

        public async Task<TResponse> SendAsync<TResponse>(string method, string endpoint,
            string bucketId = null, ClientBucketType clientBucket = ClientBucketType.Unbucketed,
            RequestOptions options = null) where TResponse : class
        {
            options = options ?? new RequestOptions();
            options.BucketId = bucketId;
        ...
        internal Task<TResponse> SendJsonAsync<TResponse>(string method, Expression<Func<string>> endpointExpr,
            object payload, BucketIds ids,
            ClientBucketType clientBucket = ClientBucketType.Unbucketed, RequestOptions options = null,
            [CallerMemberName] string funcName = null) where TResponse : class
            => SendJsonAsync<TResponse>(method, GetEndpoint(endpointExpr), payload,
                GetBucketId(ids, endpointExpr, AuthTokenType, funcName), clientBucket, options);
        ...
        internal Task<TResponse> SendMultipartAsync<TResponse>(string method, Expression<Func<string>> endpointExpr,
            IReadOnlyDictionary<string, object> multipartArgs, BucketIds ids,
            ClientBucketType clientBucket = ClientBucketType.Unbucketed, RequestOptions options = null,
            [CallerMemberName] string funcName = null)
        ...
        public async Task<TResponse> SendMultipartAsync<TResponse>(string method, string endpoint,
            IReadOnlyDictionary<string, object> multipartArgs,
            string bucketId = null, ClientBucketType clientBucket = ClientBucketType.Unbucketed,
            RequestOptions options = null)
        {
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<GetGatewayResponse>("GET", () => "gateway", new BucketIds(), options: options)
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<GetBotGatewayResponse>("GET", () => "gateway/bot", new BucketIds(), options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Channel> GetChannelAsync(ulong channelId, RequestOptions options = null)
        {
            ...
            try
            {
                ...
                return await SendAsync<Channel>("GET", () => $"channels/{channelId}", ids, options: options)
                    .ConfigureAwait(false);
            }
        ...
        public async Task<Channel> GetChannelAsync(ulong guildId, ulong channelId, RequestOptions options = null)
        {
            ...
            {
                var ids = new BucketIds(channelId: channelId);
                var model = await SendAsync<Channel>("GET", () => $"channels/{channelId}", ids, options: options)
                    .ConfigureAwait(false);
        ...
        public async Task<IReadOnlyCollection<Channel>> GetGuildChannelsAsync(ulong guildId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            options = RequestOptions.CreateOrClone(options);

            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<Channel>>("GET", () => $"guilds/{guildId}/channels", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<Channel> CreateGuildChannelAsync(ulong guildId, CreateGuildChannelParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<Channel>("POST", () => $"guilds/{guildId}/channels", args, ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Channel> DeleteChannelAsync(ulong channelId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendAsync<Channel>("DELETE", () => $"channels/{channelId}", ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<Channel> ModifyGuildChannelAsync(ulong channelId, ModifyGuildChannelParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendJsonAsync<Channel>("PATCH", () => $"channels/{channelId}", args, ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<Channel> ModifyGuildChannelAsync(ulong channelId, ModifyTextChannelParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotNull(args, nameof(args));
        ...
        public async Task<Channel> ModifyGuildChannelAsync(ulong channelId, ModifyVoiceChannelParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotNull(args, nameof(args));
        ...
        public async Task ModifyGuildChannelsAsync(ulong guildId, IEnumerable<ModifyGuildChannelsParams> args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            ...
            switch (channels.Length)
            {
                case 0:
                    return;
                case 1:
                    await ModifyGuildChannelAsync(channels[0].Id,
                        new ModifyGuildChannelParams {Position = channels[0].Position}).ConfigureAwait(false);
                    break;
                default:
                    var ids = new BucketIds(guildId);
                    await SendJsonAsync("PATCH", () => $"guilds/{guildId}/channels", channels, ids, options: options)
                        .ConfigureAwait(false);
                    break;
            }
        }
            ...
            RequestOptions options = null)
        {
            ...
            {
                var ids = new BucketIds(channelId: channelId);
                return await SendAsync<Message>("GET", () => $"channels/{channelId}/messages/{messageId}", ids,
                    options: options).ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound)
            {
        ...
        public async Task<IReadOnlyCollection<Message>> GetChannelMessagesAsync(ulong channelId,
            GetChannelMessagesParams args, RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotNull(args, nameof(args));
            ...
            return await SendAsync<IReadOnlyCollection<Message>>("GET", endpoint, ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<Message> CreateMessageAsync(ulong channelId, CreateMessageParams args,
            RequestOptions options = null)
        {
            Preconditions.NotNull(args, nameof(args));
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendJsonAsync<Message>("POST", () => $"channels/{channelId}/messages", args, ids,
                ClientBucketType.SendEdit, options).ConfigureAwait(false);
        }

        public async Task<Message> CreateWebhookMessageAsync(ulong webhookId, CreateWebhookMessageParams args,
            RequestOptions options = null)
        {
            if (AuthTokenType != TokenType.Webhook)
                throw new InvalidOperationException(
                    $"This operation may only be called with a {nameof(TokenType.Webhook)} token.");
            ...
            return await SendJsonAsync<Message>("POST", () => $"webhooks/{webhookId}/{AuthToken}?wait=true", args,
                new BucketIds(), ClientBucketType.SendEdit, options).ConfigureAwait(false);
        }

        public async Task<Message> UploadFileAsync(ulong channelId, UploadFileParams args,
            RequestOptions options = null)
        {
            Preconditions.NotNull(args, nameof(args));
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendMultipartAsync<Message>("POST", () => $"channels/{channelId}/messages",
                args.ToDictionary(), ids, ClientBucketType.SendEdit, options).ConfigureAwait(false);
        }

        public async Task<Message> UploadWebhookFileAsync(ulong webhookId, UploadWebhookFileParams args,
            RequestOptions options = null)
        {
            if (AuthTokenType != TokenType.Webhook)
                throw new InvalidOperationException(
            ...
            return await SendMultipartAsync<Message>("POST", () => $"webhooks/{webhookId}/{AuthToken}?wait=true",
                args.ToDictionary(), new BucketIds(), ClientBucketType.SendEdit, options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteMessageAsync(ulong channelId, ulong messageId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("DELETE", () => $"channels/{channelId}/messages/{messageId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task DeleteMessagesAsync(ulong channelId, DeleteMessagesParams args, RequestOptions options = null)
        {
            ...
            switch (args.MessageIds.Length)
            {
                ...
                default:
                    var ids = new BucketIds(channelId: channelId);
                    await SendJsonAsync("POST", () => $"channels/{channelId}/messages/bulk-delete", args, ids,
                        options: options).ConfigureAwait(false);
                    break;
            }
        }

        public async Task<Message> ModifyMessageAsync(ulong channelId, ulong messageId, ModifyMessageParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotEqual(messageId, 0, nameof(messageId));
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendJsonAsync<Message>("PATCH", () => $"channels/{channelId}/messages/{messageId}", args, ids,
                ClientBucketType.SendEdit, options).ConfigureAwait(false);
        }
            ...
            RequestOptions options = null)
        {
            ...
            await SendAsync("PUT", () => $"channels/{channelId}/messages/{messageId}/reactions/{emoji}/@me", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task RemoveReactionAsync(ulong channelId, ulong messageId, ulong userId, string emoji,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotEqual(messageId, 0, nameof(messageId));
            ...
            await SendAsync("DELETE", () => $"channels/{channelId}/messages/{messageId}/reactions/{emoji}/{userId}",
                ids, options: options).ConfigureAwait(false);
        }
        ...
        public async Task RemoveAllReactionsAsync(ulong channelId, ulong messageId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", () => $"channels/{channelId}/messages/{messageId}/reactions", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<User>> GetReactionUsersAsync(ulong channelId, ulong messageId,
            string emoji, GetReactionUsersParams args, RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotEqual(messageId, 0, nameof(messageId));
            Preconditions.NotNullOrWhitespace(emoji, nameof(emoji));
            ...
            var ids = new BucketIds(channelId: channelId);
            Expression<Func<string>> endpoint = () =>
                $"channels/{channelId}/messages/{messageId}/reactions/{emoji}?limit={limit}&after={afterUserId}";
            return await SendAsync<IReadOnlyCollection<User>>("GET", endpoint, ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task AckMessageAsync(ulong channelId, ulong messageId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("POST", () => $"channels/{channelId}/messages/{messageId}/ack", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        //Channel Permissions
        public async Task ModifyChannelPermissionsAsync(ulong channelId, ulong targetId,
            ModifyChannelPermissionsParams args, RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendJsonAsync("PUT", () => $"channels/{channelId}/permissions/{targetId}", args, ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteChannelPermissionAsync(ulong channelId, ulong targetId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("DELETE", () => $"channels/{channelId}/permissions/{targetId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task AddPinAsync(ulong channelId, ulong messageId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("PUT", () => $"channels/{channelId}/pins/{messageId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task RemovePinAsync(ulong channelId, ulong messageId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("DELETE", () => $"channels/{channelId}/pins/{messageId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<IReadOnlyCollection<Message>> GetPinsAsync(ulong channelId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendAsync<IReadOnlyCollection<Message>>("GET", () => $"channels/{channelId}/pins", ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task AddGroupRecipientAsync(ulong channelId, ulong userId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("PUT", () => $"channels/{channelId}/recipients/{userId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task RemoveGroupRecipientAsync(ulong channelId, ulong userId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(channelId: channelId);
            await SendAsync("DELETE", () => $"channels/{channelId}/recipients/{userId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Guild> GetGuildAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            {
                var ids = new BucketIds(guildId);
                return await SendAsync<Guild>("GET", () => $"guilds/{guildId}", ids, options: options)
                    .ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound)
            {
        ...
        public async Task<Guild> CreateGuildAsync(CreateGuildParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Guild>("POST", () => "guilds", args, new BucketIds(), options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Guild> DeleteGuildAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Guild>("DELETE", () => $"guilds/{guildId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Guild> LeaveGuildAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Guild>("DELETE", () => $"users/@me/guilds/{guildId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Guild> ModifyGuildAsync(ulong guildId, ModifyGuildParams args, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<Guild>("PATCH", () => $"guilds/{guildId}", args, ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<GetGuildPruneCountResponse> BeginGuildPruneAsync(ulong guildId, GuildPruneParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<GetGuildPruneCountResponse>("POST", () => $"guilds/{guildId}/prune", args, ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<GetGuildPruneCountResponse> GetGuildPruneCountAsync(ulong guildId, GuildPruneParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<GetGuildPruneCountResponse>("GET", () => $"guilds/{guildId}/prune?days={args.Days}",
                ids, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<IReadOnlyCollection<Ban>> GetGuildBansAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<Ban>>("GET", () => $"guilds/{guildId}/bans", ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Ban> GetGuildBanAsync(ulong guildId, ulong userId, RequestOptions options)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Ban>("GET", () => $"guilds/{guildId}/bans/{userId}", ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task CreateGuildBanAsync(ulong guildId, ulong userId, CreateGuildBanParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotEqual(userId, 0, nameof(userId));
            ...
            Preconditions.AtLeast(args.DeleteMessageDays, 0, nameof(args.DeleteMessageDays),
                "Prune length must be within [0, 7]");
            Preconditions.AtMost(args.DeleteMessageDays, 7, nameof(args.DeleteMessageDays),
                "Prune length must be within [0, 7]");
            options = RequestOptions.CreateOrClone(options);
            ...
            await SendAsync("PUT",
                () => $"guilds/{guildId}/bans/{userId}?delete-message-days={args.DeleteMessageDays}{reason}", ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task RemoveGuildBanAsync(ulong guildId, ulong userId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            await SendAsync("DELETE", () => $"guilds/{guildId}/bans/{userId}", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<GuildEmbed> GetGuildEmbedAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            {
                var ids = new BucketIds(guildId);
                return await SendAsync<GuildEmbed>("GET", () => $"guilds/{guildId}/embed", ids, options: options)
                    .ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound)
            {
        ...
        public async Task<GuildEmbed> ModifyGuildEmbedAsync(ulong guildId, ModifyGuildEmbedParams args,
            RequestOptions options = null)
        {
            Preconditions.NotNull(args, nameof(args));
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<GuildEmbed>("PATCH", () => $"guilds/{guildId}/embed", args, ids,
                options: options).ConfigureAwait(false);
        }

        //Guild Integrations
        public async Task<IReadOnlyCollection<Integration>> GetGuildIntegrationsAsync(ulong guildId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<Integration>>("GET", () => $"guilds/{guildId}/integrations", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<Integration> CreateGuildIntegrationAsync(ulong guildId, CreateGuildIntegrationParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Integration>("POST", () => $"guilds/{guildId}/integrations", ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<Integration> DeleteGuildIntegrationAsync(ulong guildId, ulong integrationId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Integration>("DELETE", () => $"guilds/{guildId}/integrations/{integrationId}", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<Integration> ModifyGuildIntegrationAsync(ulong guildId, ulong integrationId,
            ModifyGuildIntegrationParams args, RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotEqual(integrationId, 0, nameof(integrationId));
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<Integration>("PATCH", () => $"guilds/{guildId}/integrations/{integrationId}",
                args, ids, options: options).ConfigureAwait(false);
        }

        public async Task<Integration> SyncGuildIntegrationAsync(ulong guildId, ulong integrationId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotEqual(integrationId, 0, nameof(integrationId));
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Integration>("POST", () => $"guilds/{guildId}/integrations/{integrationId}/sync",
                ids, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<InviteMetadata> GetInviteAsync(string inviteId, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<InviteMetadata>("GET", () => $"invites/{inviteId}?with_counts=true",
        ...
        public async Task<InviteMetadata> GetVanityInviteAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<InviteMetadata>("GET", () => $"guilds/{guildId}/vanity-url", ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<InviteMetadata>> GetGuildInvitesAsync(ulong guildId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<InviteMetadata>>("GET", () => $"guilds/{guildId}/invites", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<InviteMetadata>> GetChannelInvitesAsync(ulong channelId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendAsync<IReadOnlyCollection<InviteMetadata>>("GET", () => $"channels/{channelId}/invites",
                ids, options: options).ConfigureAwait(false);
        }

        public async Task<InviteMetadata> CreateChannelInviteAsync(ulong channelId, CreateChannelInviteParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendJsonAsync<InviteMetadata>("POST", () => $"channels/{channelId}/invites", args, ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Invite> DeleteInviteAsync(string inviteId, RequestOptions options = null)
        {
            ...
            return await SendAsync<Invite>("DELETE", () => $"invites/{inviteId}", new BucketIds(), options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<GuildMember> GetGuildMemberAsync(ulong guildId, ulong userId, RequestOptions options = null)
        {
            ...
            {
                var ids = new BucketIds(guildId);
                return await SendAsync<GuildMember>("GET", () => $"guilds/{guildId}/members/{userId}", ids,
                    options: options).ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound)
            {
        ...
        public async Task<IReadOnlyCollection<GuildMember>> GetGuildMembersAsync(ulong guildId,
            GetGuildMembersParams args, RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            Preconditions.GreaterThan(args.Limit, 0, nameof(args.Limit));
            ...
            return await SendAsync<IReadOnlyCollection<GuildMember>>("GET", endpoint, ids, options: options)
                .ConfigureAwait(false);
        }
            ...
            RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", () => $"guilds/{guildId}/members/{userId}{reason}", ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task ModifyGuildMemberAsync(ulong guildId, ulong userId, ModifyGuildMemberParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotEqual(userId, 0, nameof(userId));
            ...
            {
                var ids = new BucketIds(guildId);
                await SendJsonAsync("PATCH", () => $"guilds/{guildId}/members/{userId}", args, ids, options: options)
                    .ConfigureAwait(false);
            }
        }
        ...
        public async Task<IReadOnlyCollection<Role>> GetGuildRolesAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<Role>>("GET", () => $"guilds/{guildId}/roles", ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Role> CreateGuildRoleAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<Role>("POST", () => $"guilds/{guildId}/roles", ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task DeleteGuildRoleAsync(ulong guildId, ulong roleId, RequestOptions options = null)
        {
            ...
            var ids = new BucketIds(guildId);
            await SendAsync("DELETE", () => $"guilds/{guildId}/roles/{roleId}", ids, options: options)
                .ConfigureAwait(false);
        }

        public async Task<Role> ModifyGuildRoleAsync(ulong guildId, ulong roleId, ModifyGuildRoleParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotEqual(roleId, 0, nameof(roleId));
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<Role>("PATCH", () => $"guilds/{guildId}/roles/{roleId}", args, ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<Role>> ModifyGuildRolesAsync(ulong guildId,
            IEnumerable<ModifyGuildRolesParams> args, RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<IReadOnlyCollection<Role>>("PATCH", () => $"guilds/{guildId}/roles", args, ids,
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Emoji> CreateGuildEmoteAsync(ulong guildId, CreateGuildEmoteParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
        ...
        public async Task<Emoji> ModifyGuildEmoteAsync(ulong guildId, ulong emoteId, ModifyGuildEmoteParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotEqual(emoteId, 0, nameof(emoteId));
            ...
            var ids = new BucketIds(guildId);
            return await SendJsonAsync<Emoji>("PATCH", () => $"guilds/{guildId}/emojis/{emoteId}", args, ids,
                options: options);
        }
        ...
        public async Task<User> GetUserAsync(ulong userId, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<User>("GET", () => $"users/{userId}", new BucketIds(), options: options)
                    .ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound)
            {
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<User>("GET", () => "users/@me", new BucketIds(), options: options)
                .ConfigureAwait(false);
        }
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<IReadOnlyCollection<Connection>>("GET", () => "users/@me/connections",
                new BucketIds(), options: options).ConfigureAwait(false);
        }
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<IReadOnlyCollection<Channel>>("GET", () => "users/@me/channels", new BucketIds(),
                options: options).ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<UserGuild>> GetMyGuildsAsync(GetGuildSummariesParams args,
            RequestOptions options = null)
        {
            Preconditions.NotNull(args, nameof(args));
            Preconditions.GreaterThan(args.Limit, 0, nameof(args.Limit));
            ...
            return await SendAsync<IReadOnlyCollection<UserGuild>>("GET",
                    () => $"users/@me/guilds?limit={limit}&after={afterGuildId}", new BucketIds(), options: options)
                .ConfigureAwait(false);
        }
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<Application>("GET", () => "oauth2/applications/@me", new BucketIds(),
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task<User> ModifySelfAsync(ModifyCurrentUserParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<User>("PATCH", () => "users/@me", args, new BucketIds(), options: options)
                .ConfigureAwait(false);
        }

        public async Task ModifyMyNickAsync(ulong guildId, ModifyCurrentUserNickParams args,
            RequestOptions options = null)
        {
            Preconditions.NotNull(args, nameof(args));
            ...
            var ids = new BucketIds(guildId);
            await SendJsonAsync("PATCH", () => $"guilds/{guildId}/members/@me/nick", args, ids, options: options)
                .ConfigureAwait(false);
        }
        ...
        public async Task<Channel> CreateDMChannelAsync(CreateDMChannelParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Channel>("POST", () => "users/@me/channels", args, new BucketIds(),
                options: options).ConfigureAwait(false);
        }
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<IReadOnlyCollection<VoiceRegion>>("GET", () => "voice/regions", new BucketIds(),
                options: options).ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<VoiceRegion>> GetGuildVoiceRegionsAsync(ulong guildId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<VoiceRegion>>("GET", () => $"guilds/{guildId}/regions", ids,
                options: options).ConfigureAwait(false);
        }

        //Audit logs
        public async Task<AuditLog> GetAuditLogsAsync(ulong guildId, GetAuditLogsParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            Preconditions.NotNull(args, nameof(args));
        ...
        //Webhooks
        public async Task<Webhook> CreateWebhookAsync(ulong channelId, CreateWebhookParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            Preconditions.NotNull(args, nameof(args));
            ...
            return await SendJsonAsync<Webhook>("POST", () => $"channels/{channelId}/webhooks", args, ids,
                options: options);
        }
        ...
        public async Task<Webhook> GetWebhookAsync(ulong webhookId, RequestOptions options = null)
        {
            ...
            {
                if (AuthTokenType == TokenType.Webhook)
                    return await SendAsync<Webhook>("GET", () => $"webhooks/{webhookId}/{AuthToken}", new BucketIds(),
                        options: options).ConfigureAwait(false);
                return await SendAsync<Webhook>("GET", () => $"webhooks/{webhookId}", new BucketIds(), options: options)
                    .ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound)
            {
        ...
        public async Task<Webhook> ModifyWebhookAsync(ulong webhookId, ModifyWebhookParams args,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(webhookId, 0, nameof(webhookId));
            Preconditions.NotNull(args, nameof(args));
            ...
            if (AuthTokenType == TokenType.Webhook)
                return await SendJsonAsync<Webhook>("PATCH", () => $"webhooks/{webhookId}/{AuthToken}", args,
                    new BucketIds(), options: options).ConfigureAwait(false);
            return await SendJsonAsync<Webhook>("PATCH", () => $"webhooks/{webhookId}", args, new BucketIds(),
                options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteWebhookAsync(ulong webhookId, RequestOptions options = null)
        {
            ...
            if (AuthTokenType == TokenType.Webhook)
                await SendAsync("DELETE", () => $"webhooks/{webhookId}/{AuthToken}", new BucketIds(), options: options)
                    .ConfigureAwait(false);
            else
                await SendAsync("DELETE", () => $"webhooks/{webhookId}", new BucketIds(), options: options)
                    .ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<Webhook>> GetGuildWebhooksAsync(ulong guildId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(guildId, 0, nameof(guildId));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(guildId);
            return await SendAsync<IReadOnlyCollection<Webhook>>("GET", () => $"guilds/{guildId}/webhooks", ids,
                options: options).ConfigureAwait(false);
        }

        public async Task<IReadOnlyCollection<Webhook>> GetChannelWebhooksAsync(ulong channelId,
            RequestOptions options = null)
        {
            Preconditions.NotEqual(channelId, 0, nameof(channelId));
            options = RequestOptions.CreateOrClone(options);
            ...
            var ids = new BucketIds(channelId: channelId);
            return await SendAsync<IReadOnlyCollection<Webhook>>("GET", () => $"channels/{channelId}/webhooks", ids,
                options: options).ConfigureAwait(false);
        }
        ...
        private static string GetBucketId(BucketIds ids, Expression<Func<string>> endpointExpr, TokenType tokenType,
            string callingMethod) =>
            _bucketIdGenerators.GetOrAdd(callingMethod, x => CreateBucketId(endpointExpr))(ids);
        ...
        private static Func<BucketIds, string> CreateBucketId(Expression<Func<string>> endpoint)
        {
            try
            {
                ...
                var endIndex = format.IndexOf('?'); //Dont include params
                if (endIndex == -1)
                ...
                while (true)
                {
                    ...
                    var argId = int.Parse(format.Substring(leftIndex + 1, rightIndex - leftIndex - 1));
                    var fieldName = GetFieldName(methodArgs[argId + 1]);

                    var mappedId = BucketIds.GetIndex(fieldName);
                    if (!mappedId.HasValue && rightIndex != endIndex && format.Length > rightIndex + 1 &&
