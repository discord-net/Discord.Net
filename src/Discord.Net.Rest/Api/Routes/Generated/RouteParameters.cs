...
{
    public sealed record ChannelId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record ApplicationId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record GuildId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record CommandId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record MessageId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record EmojiName(string Value) : RouteParameters
    {
    ...
    public sealed record EntitlementId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record UserId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record WebhookToken(string Value) : RouteParameters
    {
    ...
    public sealed record GuildScheduledEventId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record RuleId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record RoleId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record EmojiId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record InteractionId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record InteractionToken(string Value) : RouteParameters
    {
    ...
    public sealed record OverwriteId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record IntegrationId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record StickerId(Snowflake Value) : RouteParameters
    {
    ...
    public sealed record PackId(Snowflake Value) : RouteParameters
    {
