...
{
   public sealed partial record DeleteApplicationUserRoleConnection(
        RouteParameters.ApplicationId ApplicationId
    ) : IOperation, Expand<DeleteApplicationUserRoleConnection, DeleteApplicationUserRoleConnection>
    {
