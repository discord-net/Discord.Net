...
namespace Discord.Rest
{
    internal static class ClientHelper
    {
            ...
            ulong id, RequestOptions options)
        {
            ...
            return model != null ? RestChannel.Create(client, model) : null;
        }

        public static async Task<IReadOnlyCollection<IRestPrivateChannel>> GetPrivateChannelsAsync(
            ...
            string inviteId, RequestOptions options)
        {
            ...
            return model != null ? RestInviteMetadata.Create(client, null, null, model) : null;
        }
            ...
            ulong id, RequestOptions options)
        {
            ...
            return model != null ? RestGuild.Create(client, model) : null;
        }
        ...
        public static IAsyncEnumerable<IReadOnlyCollection<RestUserGuild>> GetGuildSummariesAsync(
            BaseDiscordClient client,
            ulong? fromGuildId, int? limit, RequestOptions options) => new PagedAsyncEnumerable<RestUserGuild>(
        ...
        public static async Task<IReadOnlyCollection<RestGuild>> GetGuildsAsync(BaseDiscordClient client,
            RequestOptions options)
        {
            var summaryModels = await GetGuildSummariesAsync(client, null, null, options).FlattenAsync()
        ...
        public static async Task<RestWebhook> GetWebhookAsync(BaseDiscordClient client, ulong id,
            RequestOptions options)
        {
            var model = await client.ApiClient.GetWebhookAsync(id);
            return model != null ? RestWebhook.Create(client, (IGuild)null, model) : null;
        }
