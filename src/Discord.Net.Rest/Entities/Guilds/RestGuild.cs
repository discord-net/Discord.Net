...
namespace Discord.Rest
{
    ...
    public class RestGuild : RestEntity<ulong>, IGuild, IUpdateable
    {
        ...
        public async Task ReorderChannelsAsync(IEnumerable<ReorderChannelProperties> args,
        ...
        async Task<IReadOnlyCollection<ICategoryChannel>> IGuild.GetCategoriesAsync(CacheMode mode,
            RequestOptions options)
        {
            if (mode == CacheMode.AllowDownload)
        ...
        internal void Update(Model model)
        {
            ...
            if (model.Emojis != null)
            {
                ...
                for (var i = 0; i < model.Emojis.Length; i++)
            ...
            if (model.Roles != null)
                foreach (var t in model.Roles)
                    roles[t.Id] = RestRole.Create(Discord, this, t);
        ...
        public async Task<IReadOnlyCollection<RestCategoryChannel>> GetCategoryChannelsAsync(
            RequestOptions options = null)
        {
            var channels = await GuildHelper.GetChannelsAsync(this, Discord, options).ConfigureAwait(false);
        ...
        public async Task<RestVoiceChannel> GetAFKChannelAsync(RequestOptions options = null)
        {
            ...
            if (afkId.HasValue)
            {
                var channel = await GuildHelper.GetChannelAsync(this, Discord, afkId.Value, options)
        ...
        public async Task<RestTextChannel> GetSystemChannelAsync(RequestOptions options = null)
        {
            ...
            {
                var channel = await GuildHelper.GetChannelAsync(this, Discord, systemId.Value, options)
                    .ConfigureAwait(false);
                return channel as RestTextChannel;
            }
