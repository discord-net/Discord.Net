...
namespace Discord.WebSocket
{
    ...
    public class SocketGuildChannel : SocketChannel, IGuildChannel
    {
        ...
        internal override void Update(ClientState state, Model model)
        {
            ...
            foreach (var t in overwrites)
                newOverwrites.Add(t.ToEntity());
        ...
        {
            for (var i = 0; i < _overwrites.Length; i++)
            ...
            RequestOptions options = null)
        {
            ...
            _overwrites = _overwrites.Add(new Overwrite(user.Id, PermissionTarget.User,
                new OverwritePermissions(perms.AllowValue, perms.DenyValue)));
        }
            ...
            RequestOptions options = null)
        {
            ...
            _overwrites = _overwrites.Add(new Overwrite(role.Id, PermissionTarget.Role,
                new OverwritePermissions(perms.AllowValue, perms.DenyValue)));
        }
        ...
        public async Task<RestInviteMetadata> CreateInviteAsync(int? maxAge = 86400, int? maxUses = null,
