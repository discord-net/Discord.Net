...
namespace Discord.WebSocket
{
    ...
    public class SocketDMChannel : SocketChannel, IDMChannel, ISocketPrivateChannel, ISocketMessageChannel
    {
        ...
        {
            var entity = new SocketDMChannel(discord, model.Id,
                discord.GetOrCreateUser(state, model.Recipients.Value[0]));
        ...
        public new SocketUser GetUser(ulong id)
        {
            if (id == Recipient.Id)
                return Recipient;
            return id == Discord.CurrentUser.Id ? Discord.CurrentUser : null;
        }
