...
/// </summary>
public class StageInstanceDeleteAuditLogData : ISocketAuditLogData
{
    /// <summary>
    ...
    internal StageInstanceDeleteAuditLogData(string topic, StagePrivacyLevel privacyLevel, ulong channelId)
    {
        Topic = topic;
    ...
    internal static StageInstanceDeleteAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
        ...
        return new StageInstanceDeleteAuditLogData(topic, privacyLevel, channelId ?? 0);
    }
}
