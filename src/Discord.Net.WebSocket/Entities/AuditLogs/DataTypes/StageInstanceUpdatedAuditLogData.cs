...
/// </summary>
public class StageInstanceUpdatedAuditLogData : ISocketAuditLogData
{
    /// <summary>
    ...
    internal StageInstanceUpdatedAuditLogData(ulong channelId, SocketStageInfo before, SocketStageInfo after)
    {
    ...
    internal static StageInstanceUpdatedAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
        ...
        return new StageInstanceUpdatedAuditLogData(channelId, new SocketStageInfo(oldPrivacy, oldTopic), new SocketStageInfo(newPrivacy, newTopic));
    }
}
