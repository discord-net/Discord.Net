...
/// </summary>
public class AutoModBlockedMessageAuditLogData : ISocketAuditLogData
{
    ...
    internal static AutoModBlockedMessageAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
