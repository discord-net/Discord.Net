...
/// </summary>
public class AutoModTimeoutUserAuditLogData : ISocketAuditLogData
{
    ...
    internal static AutoModTimeoutUserAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
