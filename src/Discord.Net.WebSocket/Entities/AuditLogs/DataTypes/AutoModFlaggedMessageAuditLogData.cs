...
/// </summary>
public class AutoModFlaggedMessageAuditLogData : ISocketAuditLogData
{
    ...
    internal static AutoModFlaggedMessageAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
