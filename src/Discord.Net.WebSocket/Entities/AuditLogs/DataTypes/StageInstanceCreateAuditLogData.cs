...
/// </summary>
public class StageInstanceCreateAuditLogData : ISocketAuditLogData
{
    /// <summary>
    ...
    internal StageInstanceCreateAuditLogData(string topic, StagePrivacyLevel privacyLevel, ulong channelId)
    {
        Topic = topic;
    ...
    internal static StageInstanceCreateAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
        ...
        return new StageInstanceCreateAuditLogData(topic, privacyLevel, channelId ?? 0);
    }
}
