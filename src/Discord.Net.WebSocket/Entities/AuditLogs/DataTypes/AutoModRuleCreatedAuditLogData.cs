...
/// </summary>
public class AutoModRuleCreatedAuditLogData : ISocketAuditLogData
{
    private AutoModRuleCreatedAuditLogData(SocketAutoModRuleInfo data)
    {
        Data = data;
    }

    internal static AutoModRuleCreatedAuditLogData Create(DiscordSocketClient discord, EntryModel entry)
    {
