...
namespace Discord.Audio
{
    internal partial class AudioClient
    {
        ...
        private readonly AsyncEvent<Func<ulong, bool, Task>> _speakingUpdatedEvent =
            new AsyncEvent<Func<ulong, bool, Task>>();

        private readonly AsyncEvent<Func<ulong, AudioInStream, Task>> _streamCreatedEvent =
            new AsyncEvent<Func<ulong, AudioInStream, Task>>();

        private readonly AsyncEvent<Func<ulong, Task>> _streamDestroyedEvent = new AsyncEvent<Func<ulong, Task>>();

        private readonly AsyncEvent<Func<int, int, Task>> _udpLatencyUpdatedEvent =
            new AsyncEvent<Func<int, int, Task>>();
