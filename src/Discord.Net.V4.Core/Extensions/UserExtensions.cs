...
public static class UserExtensions
{
        ...
        Embed[]? embeds = null)
    {
        return await (await user.CreateDMChannelAsync().ConfigureAwait(false))
            .SendMessageAsync(text, isTTS, embed, options, allowedMentions, components: components, embeds: embeds).ConfigureAwait(false);
    }
    ...
    {
        return await (await user.CreateDMChannelAsync().ConfigureAwait(false))
            .SendFileAsync(stream, filename, text, isTTS, embed, options, components: components, embeds: embeds).ConfigureAwait(false);
    }
    ...
    {
        return await (await user.CreateDMChannelAsync().ConfigureAwait(false))
            .SendFileAsync(filePath, text, isTTS, embed, options, components: components, embeds: embeds).ConfigureAwait(false);
    }
    ...
    {
        return await (await user.CreateDMChannelAsync().ConfigureAwait(false))
            .SendFileAsync(attachment, text, isTTS, embed, options, components: components, embeds: embeds).ConfigureAwait(false);
    }
    ...
    {
        return await (await user.CreateDMChannelAsync().ConfigureAwait(false))
            .SendFilesAsync(attachments, text, isTTS, embed, options, components: components, embeds: embeds).ConfigureAwait(false);
    }
