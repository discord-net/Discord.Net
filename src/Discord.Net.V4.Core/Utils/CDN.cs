...
public static class CDN
{
    ...
    )
    {
        ...
        return $"{config.CDNUrl}avatars/{userId}/{avatarId}.{extension}{QueryStrings.Build(nameof(size), size)}";
    }
        ...
        ushort size, ImageFormat format)
    {
        if (avatarId == null)
            return null;
        var extension = FormatToExtension(format, avatarId);
        return $"{config.CDNUrl}guilds/{guildId}/users/{userId}/avatars/{avatarId}.{extension}{QueryStrings.Build(nameof(size), size)}";
    }
    ...
    )
    {
        ...
        return $"{config.CDNUrl}banners/{userId}/{bannerId}.{extension}{QueryStrings.Build(nameof(size), size)}";
    }
