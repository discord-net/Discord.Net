...
internal static class Preconditions
{
    ...
    private static ArgumentNullException CreateNotNullException(string name, string? msg)
        => msg == null ? new ArgumentNullException(paramName: name) : new ArgumentNullException(paramName: name, message: msg);
    ...
    private static ArgumentException CreateNotEmptyException(string name, string? msg)
        => new (message: msg ?? "Argument cannot be blank.", paramName: name);
