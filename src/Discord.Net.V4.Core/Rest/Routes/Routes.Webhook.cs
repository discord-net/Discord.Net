...
{
    public static ApiBodyRoute<CreateWebhookParams, Webhook> CreateChannelWebhook(ulong channelId, CreateWebhookParams body)
    ...
    public static ApiBodyRoute<ModifyWebhookWithTokenParams, Webhook> ModifyWebhookWithToken(ulong webhookId, string token, ModifyWebhookWithTokenParams body)
    ...
    public static ApiBodyRoute<ExecuteWebhookParams, Message> ExecuteWebhook(ulong webhookId, string token, ExecuteWebhookParams body, bool wait = false, ulong? threadId = default)
    ...
    public static ApiRoute<Message> GetWebhookMessage(ulong webhookId, string token, ulong messageId, ulong? threadId = default)
    ...
    // TODO: Add support for multipart/form-data
    public static ApiBodyRoute<ModifyWebhookMessageParams, Message> ModifyWebhookMessage(ulong webhookId, string token, ulong messageId, ModifyWebhookMessageParams body, ulong? threadId = default)
