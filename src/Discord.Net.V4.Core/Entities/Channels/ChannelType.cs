...
public enum ChannelType
{
    ...
    /// <summary>
    ///     The channel is a stage voice channel. </summary>
    Stage = 13,

    /// <summary>
    ///     The channel is a guild directory used in hub servers.
    /// </summary>
    GuildDirectory = 14,

    /// <summary>
    ///     The channel is a forum channel containing multiple threads. </summary>
    Forum = 15
}
