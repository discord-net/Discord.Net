...
public readonly struct BulkBanResult(ulong[] bannedUsers, ulong[] failedUsers) : IConstructable<BulkBanResult, BulkBanResponse>
{
    ...
    {
        return new BulkBanResult(model.BannedUsers, model.FailedUsers);
    }
}
