...
public interface IEntitySource<TId, TEntity>
    ...
    where TId : IEquatable<TId>
{
    ...
    ValueTask<TEntity?> GetOrLoadAsync(RequestOptions? options = null, CancellationToken token = default)
        => Value is not null
            ? ValueTask.FromResult<TEntity?>(Value)
