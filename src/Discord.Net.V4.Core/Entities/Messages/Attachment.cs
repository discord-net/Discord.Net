...
public readonly struct Attachment
{
    ...
    /// <summary>
    ///     The media's <see href="https://en.wikipedia.org/wiki/Media_type">MIME type</see> if present; otherwise
    ///     <see langword="null" />.
    /// </summary>
    ...
    /// <summary>
    ///     The base64 encoded bytearray representing a sampled waveform. <see langword="null" /> if the attachment is not a
    ///     voice message.
    /// </summary>
