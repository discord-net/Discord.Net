...
namespace Discord.Gateway
{
    internal sealed class WebSocketGatewayConnection : IGatewayConnection
    {
        ...
        private readonly RentedArray<byte> _readBuffer;
        private readonly RentedArray<byte> _writeBuffer;
        ...
        public WebSocketGatewayConnection(DiscordGatewayClient client, DiscordGatewayConfig config)
        {
            ...
            _readBuffer = config.BufferPool.RentHandle(FRAME_SIZE);
            _writeBuffer = config.BufferPool.RentHandle(FRAME_SIZE);
        }
