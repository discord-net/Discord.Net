    ...
    ICacheableEntity<GatewayForumChannel, ulong, IGuildForumChannelModel>
{
    ...
    public static GatewayForumChannel Construct(
        ...
        client,
        context.TryGetActor(Template.Of<GatewayForumChannelActor>())?.Guild.Identity ?? GuildIdentity.Of(model.GuildId),
        model,
        context.TryGetActor(Template.Of<GatewayForumChannelActor>()),
