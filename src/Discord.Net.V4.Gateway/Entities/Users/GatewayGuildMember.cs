...
{
    public sealed class GatewayGuildMember : GatewayUser, ICacheableEntity<ulong, IMemberModel>, IGuildMember
    {
        ...
        internal GatewayGuildMember(DiscordGatewayClient client, ulong guildId, IMemberModel model, IUserModel user)
            : base(client, user)
        {
        ...
        ILoadableEntity<IGuild, ulong> IGuildMember.Guild => Guild;
