...
{
    [field: MaybeNull]
    public JsonTypeInfo<DirectoryChannelModel> DirectoryChannelModel => field ??= Discord.Models.Json.DirectoryChannelModel.CreateTypeInfo(Options);
}
...
public record DirectoryChannelModel(
    ...
    IJsonModel,
    IApiModel<IDirectoryChannelModel, DirectoryChannelModel>
{
    public static JsonTypeInfo<DirectoryChannelModel> CreateTypeInfo(JsonSerializerOptions options) => JsonMetadataServices.CreateObjectInfo<DirectoryChannelModel>(
        options,
        new JsonObjectInfoValues<DirectoryChannelModel>()
        {
            ObjectWithParameterizedConstructorCreator = static args => new DirectoryChannelModel(
                ...
                ParentId: (Discord.Models.Optional<Nullable<Discord.Models.Snowflake>>)args[8]
            ),
    ...
    public static JsonPropertyInfo[] CreatePropertyInfos(JsonSerializerOptions options) => [
        JsonMetadataServices.CreatePropertyInfo<string>(
            ...
            new JsonPropertyInfoValues<string>
            {
                IsProperty = true,
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).Name,
                Setter = null,
                PropertyName = "Name",
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Snowflake>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Snowflake>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).GuildId,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<int>(
            ...
            new JsonPropertyInfoValues<int>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).Position,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<System.Collections.Generic.IReadOnlyList<Discord.Models.IOverwriteModel>>(
            ...
            new JsonPropertyInfoValues<System.Collections.Generic.IReadOnlyList<Discord.Models.IOverwriteModel>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).PermissionOverwrites,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<Discord.Models.PermissionBitSet>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<Discord.Models.PermissionBitSet>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).Permissions,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.ChannelType>(
            ...
            new JsonPropertyInfoValues<Discord.Models.ChannelType>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).Type,
                Setter = null,
                PropertyName = "Type",
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.ChannelFlags>(
            ...
            new JsonPropertyInfoValues<Discord.Models.ChannelFlags>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).Flags,
                Setter = null,
                PropertyName = "Flags",
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Snowflake>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Snowflake>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).Id,
                Setter = null,
                PropertyName = "Id",
                JsonPropertyName = "id",
                IgnoreCondition = JsonIgnoreCondition.Never
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<Nullable<Discord.Models.Snowflake>>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<Nullable<Discord.Models.Snowflake>>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.DirectoryChannelModel),
                Getter = static instance => ((Discord.Models.Json.DirectoryChannelModel)instance).ParentId,
                Setter = null,
    ...
    public static DirectoryChannelModel From(IDirectoryChannelModel model) => (model as DirectoryChannelModel) ?? new DirectoryChannelModel(
        Name: model.Name,
    ...
    static DirectoryChannelModel IApiModel<IDirectoryChannelModel, DirectoryChannelModel>.From(IDirectoryChannelModel model) => From(model);
}