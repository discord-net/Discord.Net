...
{
    [field: MaybeNull]
    public JsonTypeInfo<MentionableSelectComponentModel> MentionableSelectComponentModel => field ??= Discord.Models.Json.MentionableSelectComponentModel.CreateTypeInfo(Options);
}

public record MentionableSelectComponentModel(
    ...
    IMentionableSelectComponentModel,
    IJsonModel,
    IApiModel<IMentionableSelectComponentModel, MentionableSelectComponentModel>
{
    public static JsonTypeInfo<MentionableSelectComponentModel> CreateTypeInfo(JsonSerializerOptions options) => JsonMetadataServices.CreateObjectInfo<MentionableSelectComponentModel>(
        options,
        new JsonObjectInfoValues<MentionableSelectComponentModel>()
        {
            ObjectWithParameterizedConstructorCreator = static args => new MentionableSelectComponentModel(
    ...
    public static JsonPropertyInfo[] CreatePropertyInfos(JsonSerializerOptions options) => [
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<string>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<string>>
            {
                IsProperty = true,
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).Placeholder,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<System.Collections.Generic.IReadOnlyList<Discord.Models.ISelectDefaultValueModel>>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<System.Collections.Generic.IReadOnlyList<Discord.Models.ISelectDefaultValueModel>>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).DefaultValues,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<int>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<int>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).MinValues,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<int>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<int>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).MaxValues,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<bool>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<bool>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).Disabled,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.ComponentType>(
            ...
            new JsonPropertyInfoValues<Discord.Models.ComponentType>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).Type,
                Setter = null,
                PropertyName = "Type",
        ...
        JsonMetadataServices.CreatePropertyInfo<Nullable<int>>(
            ...
            new JsonPropertyInfoValues<Nullable<int>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).Id,
                Setter = null,
                PropertyName = "Id",
                JsonPropertyName = "id",
                IgnoreCondition = JsonIgnoreCondition.Never
        ...
        JsonMetadataServices.CreatePropertyInfo<string>(
            ...
            new JsonPropertyInfoValues<string>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.MentionableSelectComponentModel),
                Getter = static instance => ((Discord.Models.Json.MentionableSelectComponentModel)instance).CustomId,
                Setter = null,
    ...
    public static MentionableSelectComponentModel From(IMentionableSelectComponentModel model) => (model as MentionableSelectComponentModel) ?? new MentionableSelectComponentModel(
    ...
    static MentionableSelectComponentModel IApiModel<IMentionableSelectComponentModel, MentionableSelectComponentModel>.From(IMentionableSelectComponentModel model) => From(model);
}