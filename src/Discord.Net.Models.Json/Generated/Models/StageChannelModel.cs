...
{
    [field: MaybeNull]
    public JsonTypeInfo<StageChannelModel> StageChannelModel => field ??= Discord.Models.Json.StageChannelModel.CreateTypeInfo(Options);
}

public record StageChannelModel(
    bool IsNSFW,
    string? Topic,
    ...
    IStageChannelModel,
    IJsonModel,
    IApiModel<IStageChannelModel, StageChannelModel>
{
    public static JsonTypeInfo<StageChannelModel> CreateTypeInfo(JsonSerializerOptions options) => JsonMetadataServices.CreateObjectInfo<StageChannelModel>(
        options,
        new JsonObjectInfoValues<StageChannelModel>()
        {
            ObjectWithParameterizedConstructorCreator = static args => new StageChannelModel(
                IsNSFW: (bool)args[0],
                Topic: (string?)args[1],
                ...
                Name: (string)args[5],
                GuildId: (Discord.Snowflake)args[6],
                Position: (int)args[7],
                ...
                Id: (Discord.Snowflake)args[12],
                ParentId: (Discord.Models.Optional<Nullable<Discord.Snowflake>>)args[13]
            ),
    ...
    public static JsonPropertyInfo[] CreatePropertyInfos(JsonSerializerOptions options) => [
        JsonMetadataServices.CreatePropertyInfo<bool>(
            ...
            new JsonPropertyInfoValues<bool>
            {
                IsProperty = true,
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).IsNSFW,
                Setter = null,
                PropertyName = "IsNSFW",
        ...
        JsonMetadataServices.CreatePropertyInfo<string?>(
            ...
            new JsonPropertyInfoValues<string?>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Topic,
                Setter = null,
                PropertyName = "Topic",
        ...
        JsonMetadataServices.CreatePropertyInfo<int>(
            ...
            new JsonPropertyInfoValues<int>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).RateLimitPerUser,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<int>(
            ...
            new JsonPropertyInfoValues<int>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Bitrate,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<int>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<int>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).UserLimit,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<string>(
            ...
            new JsonPropertyInfoValues<string>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Name,
                Setter = null,
                PropertyName = "Name",
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Snowflake>(
            ...
            new JsonPropertyInfoValues<Discord.Snowflake>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).GuildId,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<int>(
            ...
            new JsonPropertyInfoValues<int>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Position,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<System.Collections.Generic.IReadOnlyList<Discord.Models.IOverwriteModel>>(
            ...
            new JsonPropertyInfoValues<System.Collections.Generic.IReadOnlyList<Discord.Models.IOverwriteModel>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).PermissionOverwrites,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<Discord.Models.PermissionBitSet>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<Discord.Models.PermissionBitSet>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Permissions,
                Setter = null,
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.ChannelType>(
            ...
            new JsonPropertyInfoValues<Discord.Models.ChannelType>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Type,
                Setter = null,
                PropertyName = "Type",
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.ChannelFlags>(
            ...
            new JsonPropertyInfoValues<Discord.Models.ChannelFlags>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Flags,
                Setter = null,
                PropertyName = "Flags",
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Snowflake>(
            ...
            new JsonPropertyInfoValues<Discord.Snowflake>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).Id,
                Setter = null,
                PropertyName = "Id",
                JsonPropertyName = "id",
                IgnoreCondition = JsonIgnoreCondition.Never
        ...
        JsonMetadataServices.CreatePropertyInfo<Discord.Models.Optional<Nullable<Discord.Snowflake>>>(
            ...
            new JsonPropertyInfoValues<Discord.Models.Optional<Nullable<Discord.Snowflake>>>
            {
                ...
                IsPublic = true,
                DeclaringType = typeof(Discord.Models.Json.StageChannelModel),
                Getter = static instance => ((Discord.Models.Json.StageChannelModel)instance).ParentId,
                Setter = null,
    ...
    public static StageChannelModel From(IStageChannelModel model) => (model as StageChannelModel) ?? new StageChannelModel(
        IsNSFW: model.IsNSFW,
        Topic: model.Topic,
    ...
    static StageChannelModel IApiModel<IStageChannelModel, StageChannelModel>.From(IStageChannelModel model) => From(model);
}