...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        /// <summary>
        ///     Get the <see cref="MetadataReference" /> for <paramref name="assembly" /> and all assemblies referenced by
        ...
        private static HashSet<Assembly> RecursiveReferencedAssemblies(Assembly a, HashSet<Assembly> assemblies = null)
        {
            ...
            if (!assemblies.Add(a)) return assemblies;
        ...
        private static Diagnostic[]
            GetSortedDiagnostics(string[] sources, string language, DiagnosticAnalyzer analyzer) =>
